...
class FollowersPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => getIt<FollowBloc>()..add(LoadFollowers(userId)),
...
class _FollowersViewState extends State<FollowersView> {
  ...
  void _onScroll() {
    if (_isBottom) {
      context.read<FollowBloc>().add(LoadMoreFollowers(widget.userId));
    }
  }
  ...
  Future<void> _onRefresh() async {
    context.read<FollowBloc>().add(RefreshFollowers(widget.userId));
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const AppHeader(title: 'Followers'),
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () => context.read<FollowBloc>().add(LoadFollowers(widget.userId)),
