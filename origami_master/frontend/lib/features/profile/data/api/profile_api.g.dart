...
class _ProfileApi implements ProfileApi {
  ...
  Future<Pagination<UserPostResponseDto>> getUserPosts(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Pagination<UserPostResponseDto>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/users/${userId}/posts',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late Pagination<UserPostResponseDto> _value;
    try {
      _value = Pagination<UserPostResponseDto>.fromJson(
        _result.data!,
        (json) => UserPostResponseDto.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
